...
(function () {
  ...
  let notas = typeof bbGetPostitsDelDia === "function"
    ? bbGetPostitsDelDia()
    : [];
  ...
  area.innerHTML = notas
    .map(
      ...
      <div class="piz-postit ${COLORES_POSTIT[i % 4]}">
        <span class="piz-postit-emoji">${n.sello || EMOJIS_POSTIT[i % 6]}</span>
        ${n.texto || n.contenido || ""}
      </div>
    `
    )
  ...
  // ── Maneja pulsación de tecla en el PIN ──
  ...
  // ── Ejecuta el ingreso y cierra el modal ──
